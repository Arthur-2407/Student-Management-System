...
DROP INDEX IF EXISTS idx_leave_student_status;
DROP INDEX IF EXISTS idx_attendance_student_time;
DROP INDEX IF EXISTS idx_audit_logs_action_created;
DROP INDEX IF EXISTS idx_audit_logs_actor_created;
DROP INDEX IF EXISTS idx_notifications_unread;
DROP INDEX IF EXISTS idx_notifications_student_created;
...
DROP INDEX IF EXISTS idx_students_locked_until;
DROP INDEX IF EXISTS idx_students_active_role;
