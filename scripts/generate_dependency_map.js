...
const scanData = {
  ...
  features: {
    'Admin Bootstrap Setup': {
      ...
      services: ['student-backend-prod', 'student-face-ai-prod'],
      database: ['students', 'face_embeddings', 'security_events', 'audit_logs'],
    ...
    'MFA Face Authentication': {
      ...
      services: ['student-backend-prod', 'student-face-ai-prod'],
      database: ['students', 'face_embeddings', 'login_logs', 'security_events'],
...
try {
  ...
  scanData.systemIntegrity.backendSyntaxOk = fs.existsSync(path.join(ROOT, 'student-backend', 'src', 'server.js'));
